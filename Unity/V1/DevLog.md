...
<div align="center">
  <img src="https://github.com/user-attachments/assets/1f8269d9-17a7-4ffb-88ba-023864c68c80" alt="Create Bird Object1" width="750">
</div>
...
**1. Create Scoreboard**
  1-1. Create new object: Legacy/Text. Will need to zoom out to see the screen.
  1-2. Canvas/Canvas Scaler -> set to _'Scale With Screen Size'_ and set _Reference Resolution_.
  1-3. Set Text position, Width, Height, Font, Default Text, Text Color.
